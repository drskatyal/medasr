...
const STT_ENGINES = [
  ...
  { id: 'omi-med-stt', label: 'Omi Med STT v1 — medical (#1 open WER)', runtime: 'parakeet-tdt', implemented: false,
    note: 'CC-BY-4.0, Parakeet-TDT based (fast/streaming). Needs the sherpa-onnx / onnx-asr adapter.' },
  { id: 'parakeet-medical', label: 'Parakeet TDT 0.6B — Medical (fast, EN)', runtime: 'parakeet-tdt', implemented: false,
